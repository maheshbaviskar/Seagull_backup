...
clear
flag=`grep 'set-value name="Session-Id" format="' ~/mahesh/Seagull_client/scenario-oca-pcef-sms.xml| cut -d'"' -f4`
flag1=`grep 'avp name="Subscription-Id-Data" value="' ~/mahesh/Seagull_client/scenario-oca-pcef-sms.xml| cut -d'"' -f4`
flag2=`grep 'avp name="Event-Timestamp" value="' ~/mahesh/Seagull_client/scenario-oca-pcef-sms.xml| cut -d'"' -f4`
flagc5=`grep 'avp name="3GPP-SGSN-MCC-MNC" value="' ~/mahesh/Seagull_client/scenario-oca-pcef-sms.xml| cut -d'"' -f4`
flagc3=`grep 'avp name="Service-Parameter-value" value="' ~/mahesh/Seagull_client/scenario-oca-pcef-sms.xml| cut -d'"' -f4`
flagc4=`grep 'avp name="Address-data" value="' ~/mahesh/Seagull_client/scenario-oca-pcef-sms.xml| cut -d'"' -f4`
...
sed -i "s/avp\ name\=\"3GPP-SGSN-MCC-MNC\"\ value\=\"$flag5/avp\ name\=\"3GPP-SGSN-MCC-MNC\"\ value\=\"$GPP/g" scenario-oca-pcef-sms.xml
sed -i "s/avp\ name\=\"Event-Timestamp\"\ value\=\"$flag2/avp\ name\=\"Event-Timestamp\"\ value\=\"$TIMESTAMP/g" scenario-oca-pcef-sms.xml
sed -i "s/avp\ name\=\"Service-Parameter-value\"\ value\=\"$flag3/avp\ name\=\"Service-Parameter-value\"\ value\=\"$SNC/g" scenario-oca-pcef-sms.xml
sed -i "s/avp\ name\=\"Address-data\"\ value\=\"$flag4/avp\ name\=\"Address-data\"\ value\=\"$NC/g" scenario-oca-pcef-sms.xml
